...
static int panel_aa551_p_3_a0004_dsc_on(struct panel_aa551_p_3_a0004_dsc *ctx)
{
	...
	mipi_dsi_dcs_write_seq(dsi, 0xed,
			       0xff, 0xff, 0xff, 0xf7, 0xff, 0xff, 0xbf, 0xff);
	mipi_dsi_dcs_write_seq(dsi, 0xee,
			       0xfe, 0xef, 0xc1, 0xe0, 0x00, 0xc0, 0x01, 0x00);
	...
	mipi_dsi_dcs_write_seq(dsi, 0xd0,
			       0xff, 0xaf, 0x56, 0x3d, 0x2d, 0x2d, 0x2d, 0x2d,
			       0xff);
	mipi_dsi_dcs_write_seq(dsi, 0xff, 0x08, 0x38, 0x00);
	...
	mipi_dsi_dcs_write_seq(dsi, 0xd9,
			       0x00, 0xd6, 0x11, 0x10, 0x32, 0x14, 0x14);
	mipi_dsi_dcs_write_seq(dsi, 0xdc,
			       0x84, 0x94, 0xbb, 0x00, 0x20, 0xc4, 0xa1, 0xcc,
			       0x10);
	...
	mipi_dsi_dcs_write_seq(dsi, 0xe0,
			       0x02, 0x00, 0x5f, 0x21, 0x00, 0x3c, 0x28, 0x00);
	...
	mipi_dsi_dcs_write_seq(dsi, 0x82,
			       0x00, 0x00, 0x40, 0x0a, 0x00, 0x11, 0x08, 0x04,
			       0x00, 0x0f, 0x00, 0x00, 0x3e, 0xfc);
	mipi_dsi_dcs_write_seq(dsi, 0x83,
			       0x00, 0x00, 0xc0, 0x00, 0x10, 0x18, 0x08, 0x18,
	...
	mipi_dsi_dcs_write_seq(dsi, 0xd4,
			       0x00, 0x06, 0x06, 0x06, 0x06, 0x06, 0x00, 0x80);
	...
	mipi_dsi_dcs_write_seq(dsi, 0xa0,
			       0x04, 0x04, 0x04, 0x04, 0x04, 0x04, 0x04, 0x04,
			       0x04, 0x00, 0x04, 0x05, 0x04, 0x04, 0x03, 0x04);
	mipi_dsi_dcs_write_seq(dsi, 0xa4,
			       0x04, 0x01, 0x01, 0x00, 0x01, 0x00, 0x04, 0x04,
			       0x00, 0x04, 0x04, 0x04, 0x05, 0x04, 0x04, 0x04,
			       0x04);
	mipi_dsi_dcs_write_seq(dsi, 0xa5,
			       0x04, 0x04, 0x04, 0x04, 0xfa, 0x0f, 0x10, 0x04,
			       0x04, 0x00, 0x04, 0x09, 0x05, 0x04, 0x03, 0x04);
	mipi_dsi_dcs_write_seq(dsi, 0xa9,
			       0x00, 0x01, 0x01, 0x00, 0x01, 0x00, 0x04, 0x04,
			       0x00, 0x03, 0x04, 0x04, 0x05, 0x04, 0x04, 0x04,
			       0x04);
	mipi_dsi_dcs_write_seq(dsi, 0xaa,
			       0x04, 0x04, 0x04, 0x04, 0x08, 0x08, 0x04, 0x04,
			       0x04, 0x00, 0x04, 0x05, 0x04, 0x04, 0x04, 0x04);
	mipi_dsi_dcs_write_seq(dsi, 0xae,
			       0x02, 0x01, 0x01, 0x00, 0x01, 0x00, 0x04, 0x04,
			       0x00, 0x03, 0x04, 0x04, 0x05, 0x04, 0x04, 0x04,
			       0x04);
	mipi_dsi_dcs_write_seq(dsi, 0xb0,
			       0x01, 0x01, 0x01, 0x01, 0x0b, 0x01, 0x16, 0x00,
			       0x05, 0x03, 0x35, 0x03, 0x15, 0x0f, 0x05, 0x20,
			       0x10, 0x23);
	mipi_dsi_dcs_write_seq(dsi, 0xb1,
			       0x00, 0x00, 0x00, 0x01, 0x05, 0xfe, 0xfe, 0x05,
			       0x01, 0x01, 0x69, 0xfe, 0x37, 0x30, 0x24, 0x16,
			       0x08, 0x03);
	mipi_dsi_dcs_write_seq(dsi, 0xb4,
			       0x03, 0x06, 0x06, 0x06, 0x06, 0x06, 0x14, 0x06,
			       0x05, 0x01, 0x24, 0x02, 0x13, 0x0e, 0x06, 0x20,
			       0x0f, 0x22);
	mipi_dsi_dcs_write_seq(dsi, 0xb5,
			       0x1d, 0x13, 0x04, 0xff, 0x10, 0x0f, 0x0f, 0x0c,
			       0x02, 0x03, 0x74, 0x3c, 0x38, 0x2f, 0x26, 0x15,
			       0x0a, 0x04);
	mipi_dsi_dcs_write_seq(dsi, 0xb8,
			       0x04, 0x04, 0x02, 0x08, 0x02, 0x01, 0x18, 0x07,
			       0x05, 0x03, 0x34, 0x16, 0x13, 0x0f, 0x08, 0x55,
			       0x28, 0x24);
	mipi_dsi_dcs_write_seq(dsi, 0xb9,
			       0x1d, 0x13, 0x07, 0x04, 0x30, 0x2b, 0x24, 0x05,
			       0x02, 0x01, 0x70, 0x3b, 0x33, 0x2b, 0x1f, 0x10,
			       0x05, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0xff, 0x08, 0x38, 0x49);
